...
SECRET_KEY = 'django-insecure-l*t@2d6sc0q=2!0ht7zhcssk--+!e6(8$e+1-!zjci$5peab2b'
...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER'),                   # Database user from environment.
        'PASSWORD': config('DB_PASSWORD'),           # User's password from environment.
        'HOST': config('DB_HOST'),                   # Host from environment.
